def create_favorite_hash(color, number)
    ...
    {color.to_sym => color, number.to_sym => number }
  end
  ...
  def merge_favorites_with_block(original_list, additional_list)
    # merge the two hashes: original_list and additional_list
    # use a block to merge the values of the two hashes
    original_list.merge(additional_list) { |key, value1, value2| value1 + value2 }
  end